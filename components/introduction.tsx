  ...
  return (
    <div dir="rtl">
      <div className="flex ss:hidden flex-col rounded-xl mx-6">
        ...
        <div className="bg-[#f4f4f4] rounded-b-2xl">
      ...
      <div className="mx-6 sm:mx-8 md:mx-[60px] lg:mx-[78.05px] h-[486px] bg-[#f4f4f4] hidden ss:flex rounded-[34px]  ">
        <div className="flex-1 flex items-center justify-center min-w-0">
          <div className="w-full mx-6 min-h-[334px]">
            <section className="w-full h-full flex flex-col gap-[clamp(1rem,0.643rem+0.951vw,1.5rem)]">
              ...
              <p className="text-[clamp(0.875rem,0.607rem+0.713vw,1.25rem)]">
                سپوی یک سامانه هوشمند مدیریت سرویس‌های حمل‌ونقل است که با تکیه
                بر علم داده و هوش مصنوعی، جابجایی افراد در کارخانه ها، مدارس و
                سازمان‌ها را بهینه می‌کند. این سامانه با خوشه‌بندی هوشمند افراد،
                تعیین ایستگاه‌های بهینه و پیشنهاد خودرو مناسب، به کاهش هزینه‌ها
                و صرفه‌جویی در زمان کمک می‌کند. از سوی دیگر، شرکت‌های حمل‌ونقل
                می‌توانند ناوگان و تعرفه‌های خود را ثبت کنند تا خدمات‌گیرندگان
                بهترین انتخاب را داشته باشند. به همراه اپلیکیشن موبایل، همه‌ی
                مدیران، رانندگان و مسافران تجربه‌ای یکپارچه، ساده و کارآمد
                خواهند داشت.
              </p>
              <Button
